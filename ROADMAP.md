...
- [ ] **Product API persistence** — `graphToProductApiDNA` + `saveProductApi` (mirrors the operational pattern). Unblocks Ctrl+S round-tripping edits back to `product.api.json`.
