...
export function generateDbIndex(config: { database: string; port?: number; app_role?: string; app_password?: string }): string {
...
const connectionString = process.env.DATABASE_URL
  ?? 'postgresql://${role}:${password}@localhost:${port}/${config.database}'
